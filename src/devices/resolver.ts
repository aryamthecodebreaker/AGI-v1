...
export function knownGroupSlugs(storage: DeviceStorage, userId: string): string[] {
...
export function resolveTargets(storage: DeviceStorage, input: ResolveInput): ResolvedTargets {
